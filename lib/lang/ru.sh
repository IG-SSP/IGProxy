...
I18N[install_lite_title]="⚡ Только прокси — маскировка под популярный сайт"
...
I18N[install_pro_title]="🛡  Свой домен и сайт — полная маскировка"
...
I18N[install_mode_choice]="Выбор (1/2/3):"
I18N[install_bad_choice]="Неверный выбор: %s"
I18N[install_lite_step]="Установка прокси без собственного сайта"
I18N[install_pro_step]="Установка прокси со своим доменом и сайтом"
...
I18N[install_done]="goTelegram v%s установлен: %s"
I18N[install_arch_desc1]="telemt принимает трафик прокси на публичном порту %s"
I18N[install_arch_desc2]="nginx обслуживает сайт на внутреннем порту %s"
I18N[install_arch_desc3]="Провайдер видит HTTPS-трафик к %s:%s"

# ── Change mode/template ────────────────────────────────────────────────
I18N[change_current_mode]="Текущий режим:"
I18N[change_template]="Сменить шаблон собственного сайта"
I18N[change_mode_switch]="Выбрать другой сценарий установки"
I18N[change_only_pro]="Смена шаблона доступна только в сценарии со своим доменом и сайтом"
...
I18N[website_only_pro]="Управление сайтом доступно только в сценарии со своим доменом и сайтом"
...
I18N[backup_restored_gotelegram]="Конфигурация goTelegram восстановлена"
...
# ── Migration ───────────────────────────────────────────────────────────
I18N[v1_detected]="⚠️  Обнаружена старая установка goTelegram v1 (mtg)"
...
# ── Дисклеймер + ленивый режим (порт из goVLESS, адаптировано под MTProxy) ──
I18N[disclaimer_title]="ДИСКЛЕЙМЕР / ПРАВОВОЕ ПРЕДУПРЕЖДЕНИЕ"
I18N[disclaimer_intro]="Все материалы скрипта и сопровождающей документации предназначены ИСКЛЮЧИТЕЛЬНО в информационных целях и раскрывают техническую сторону развёртывания частного (белого) MTProxy-сервера для Telegram."
...
I18N[disclaimer_legal_1]="• Использование прокси- и VPN-технологий в РФ не запрещено, однако доступ к ресурсам, заблокированным по решению Роскомнадзора (в том числе признанным экстремистскими), может рассматриваться как нарушение законодательства."
I18N[disclaimer_legal_2]="• Сам факт установки и использования прокси не является правонарушением, но использование в противоправных целях (распространение запрещённого контента, экстремизм, клевета, дискредитация и т.д.) может повлечь административную или уголовную ответственность."
I18N[disclaimer_legal_3]="• Автор не распространяет информацию о способах обхода блокировок, не призывает к нарушению закона и не рекламирует прокси/VPN-сервисы."
...
I18N[disclaimer_anonymity_note]="📌 Ни один прокси или VPN не гарантирует полной анонимности. В РФ действуют системы контроля интернет-трафика (СОРМ, DPI), а также предусмотрены административные и уголовные санкции при выявлении противоправных действий, даже если они совершены через прокси."
...
I18N[install_lazy_title]="🚀 Ленивый (Pro авто, только домен) · рекомендуется"
I18N[install_lazy_desc1]="Свой домен + сайт-маскировка. Всё авто: случайный шаблон,"
I18N[install_lazy_desc2]="5 ключей, авто-подтверждение. Вводите только домен."
I18N[lazy_active]="Ленивый режим: авто-настройка (случайный шаблон, 5 ключей)."
I18N[lazy_template]="Случайный шаблон: %s"
I18N[lazy_autoconfirm]="Подтверждено автоматически — устанавливаю…"
I18N[lazy_dns_warn]="DNS для %s ещё не указывает на %s — продолжаю (lazy); SSL не выпустится, пока A-запись не настроена."
I18N[lazy_keys_created]="Создано ключей: %s (управление — в меню/боте)."
I18N[diag_offer]="Подобрать оптимальный режим скорость/надёжность сейчас? (подключи Telegram и листай канал)"
I18N[diag_hint]="Тест режимов: меню → «Подбор режима (анти-DPI)» → «Тест режимов с оценкой»."

I18N[autotune_title]="⚙️  Тест режимов с оценкой (подбор под твою сеть)"
I18N[autotune_intro]="Применю режимы по очереди — подключи Telegram и оцени каждый 1-5 (1=не работает, 5=отлично). Лучший оставим."
I18N[autotune_prompt]="Enter — начать тест · s — пропустить (позже: меню → Подбор режима):"

# ── Ченджлог при обновлении ──
I18N[upd_title]="Обновление %s → %s. Что нового:"
I18N[upd_l1]="🔒 Дисклеймер с согласием при первой установке (правовое предупреждение)."
I18N[upd_l2]="🚀 «Ленивый» режим: вводишь только домен — остальное само (шаблон, 5 ключей)."
I18N[upd_l3]="📋 Новое меню установки: 1) Ленивый · 2) Pro · 3) Lite."
I18N[upd_l4]="⚙️ «Подбор режима»: 3 тира — 🛟 реаниматор · 📘 доки · 🛡 наши маск-режимы; оценка 1–5."
I18N[upd_l5]="🧪 Профили маскировки (Firefox/Chrome/Legacy) — внутри тиров; версия в боте/панели из config.json."
I18N[upd_l6]="🔧 Тюнинг ядра (cubic+fq_codel) + авто-реаниматор связи с Telegram (ME-recovery)."
I18N[upd_l7]="🛟 Реаниматор стабильности (идея @LiafanX): нативный synlimit (SYN-лимит на IP) + [timeouts] + iOS keepalive ядра — отдельное меню с настройками."
