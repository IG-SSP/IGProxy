...
I18N[install_mode_choice]="Choice (1/2/3):"
...
# ── Disclaimer + lazy mode (ported from goVLESS, adapted for MTProxy) ──
I18N[disclaimer_title]="DISCLAIMER / LEGAL NOTICE"
I18N[disclaimer_intro]="All materials in this script and accompanying documentation are provided FOR INFORMATIONAL PURPOSES ONLY and describe the technical side of deploying a private lawful-use MTProxy server for Telegram."
...
I18N[disclaimer_legal_1]="• Proxy and VPN technology is not banned per se in most jurisdictions, but accessing resources blocked by local authorities (including content classified as extremist or otherwise unlawful) may constitute a violation of law."
I18N[disclaimer_legal_2]="• The act of installing and using a proxy is not in itself a crime, but using it for unlawful purposes (distributing prohibited content, extremism, defamation, etc.) may carry administrative or criminal liability."
I18N[disclaimer_legal_3]="• The author does not publish methods to bypass blocks, does not encourage breaking the law, and does not advertise proxy/VPN services."
...
I18N[disclaimer_anonymity_note]="📌 No proxy or VPN guarantees full anonymity. Many jurisdictions operate traffic-inspection systems (DPI, lawful-intercept) and provide administrative or criminal penalties for unlawful actions, even when performed via a proxy."
...
I18N[install_lazy_title]="🚀 Lazy (Pro auto, domain only) · recommended"
I18N[install_lazy_desc1]="Your domain + site masquerade. All auto: random template,"
I18N[install_lazy_desc2]="5 keys, auto-confirm. You enter only the domain."
I18N[lazy_active]="Lazy mode: auto setup (random template, 5 keys)."
I18N[lazy_template]="Random template: %s"
I18N[lazy_autoconfirm]="Auto-confirmed — installing…"
I18N[lazy_dns_warn]="DNS for %s does not point to %s yet — continuing (lazy); SSL will fail until the A record is set."
I18N[lazy_keys_created]="Keys created: %s (manage them in the menu/bot)."
I18N[diag_offer]="Tune the speed/reliability mode now? (connect Telegram and scroll a channel)"
I18N[diag_hint]="Mode test: menu -> Mode tuning (anti-DPI) -> Rated mode test."

I18N[autotune_title]="⚙️  Rated mode test (tune for your network)"
I18N[autotune_intro]="I will apply each mode in turn — connect Telegram and rate each 1-5 (1=broken, 5=great). We keep the best."
I18N[autotune_prompt]="Enter — start test · s — skip (later: menu → Mode tuning):"

# ── Upgrade changelog ──
I18N[upd_title]="Update %s → %s. What is new:"
I18N[upd_l1]="🔒 Disclaimer with consent on first install (legal notice)."
I18N[upd_l2]="🚀 Lazy install: enter only the domain — the rest is automatic (template, 5 keys)."
I18N[upd_l3]="📋 New install menu: 1) Lazy · 2) Pro · 3) Lite."
I18N[upd_l4]="⚙️ Mode tuning: 3 tiers — 🛟 reanimator · 📘 docs · 🛡 our masking modes; 1–5 rating."
I18N[upd_l5]="🧪 Masking profiles (Firefox/Chrome/Legacy) — inside the tiers; bot/panel version from config.json."
I18N[upd_l6]="🔧 Kernel tuning (cubic+fq_codel) + auto-reanimator of the Telegram uplink (ME-recovery)."
I18N[upd_l7]="🛟 Stability reanimator (idea by @LiafanX): native synlimit (per-IP SYN limit) + [timeouts] + iOS kernel keepalive — dedicated settings menu."
